...
namespace LibraryManagement_View {
    ...
    public partial class dbLibraryDataSet1 : global::System.Data.DataSet {
        ...
        public partial class BookDataTable : global::System.Data.TypedTableBase<BookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public BookRow AddBookRow(string Author, string Title, string ISBN, bool isAvailable) {
...
namespace LibraryManagement_View.dbLibraryDataSet1TableAdapters {
    ...
    public partial class BookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Book] WHERE (([idBook] = @Original_idBook) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_ISBN = 1 AND [ISBN] IS NULL) OR ([ISBN] = @Original_ISBN)) AND ([isAvailable] = @Original_isAvailable))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Book] ([Author], [Title], [ISBN], [isAvailable]) VALUES (@Auth" +
                "or, @Title, @ISBN, @isAvailable);\r\nSELECT idBook, Author, Title, ISBN, isAvailab" +
                "le FROM Book WHERE (idBook = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Book] SET [Author] = @Author, [Title] = @Title, [ISBN] = @ISBN, [isAvailable] = @isAvailable WHERE (([idBook] = @Original_idBook) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_ISBN = 1 AND [ISBN] IS NULL) OR ([ISBN] = @Original_ISBN)) AND ([isAvailable] = @Original_isAvailable));
SELECT idBook, Author, Title, ISBN, isAvailable FROM Book WHERE (idBook = @idBook)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idBook, Author, Title, ISBN, isAvailable FROM dbo.Book";
        ...
        public virtual int Fill(dbLibraryDataSet1.BookDataTable dataTable) {
        ...
        public virtual dbLibraryDataSet1.BookDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbLibraryDataSet1.BookDataTable dataTable = new dbLibraryDataSet1.BookDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbLibraryDataSet1.BookDataTable dataTable) {
        ...
        public virtual int Delete(int Original_idBook, string Original_Author, string Original_Title, string Original_ISBN, bool Original_isAvailable) {
        ...
        public virtual int Insert(string Author, string Title, string ISBN, bool isAvailable) {
            if ((Author == null)) {
        ...
        public virtual int Update(string Author, string Title, string ISBN, bool isAvailable, int Original_idBook, string Original_Author, string Original_Title, string Original_ISBN, bool Original_isAvailable, int idBook) {
            if ((Author == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[11].Value = ((bool)(Original_isAvailable));
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(idBook));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Author, string Title, string ISBN, bool isAvailable, int Original_idBook, string Original_Author, string Original_Title, string Original_ISBN, bool Original_isAvailable) {
            return this.Update(Author, Title, ISBN, isAvailable, Original_idBook, Original_Author, Original_Title, Original_ISBN, Original_isAvailable, Original_idBook);
        }
    }
